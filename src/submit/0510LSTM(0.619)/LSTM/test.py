...
def predict_on(model, data_dl, output_file ,model_state_path=None):
    if model_state_path:
    ...
    for id_, text1, text2 in data_dl:
        ids.extend(id_.numpy())
...
predict_on(MODEL, test_dl, outfile, './model_save/LSTM_angel.pth')
